    ...
    <section className="relative min-h-screen flex flex-col justify-center overflow-hidden">
      ...
      <div className="relative z-10 mx-auto w-full max-w-site px-container-mobile md:px-container">
        <div className="grid lg:grid-cols-[1fr_1fr] gap-12 lg:gap-16 items-center">
          <div>
            <p className="text-caption font-body-medium uppercase tracking-eyebrow text-copy-light mb-10 animate-[fadeIn_0.7s_var(--ease-reveal)_0.3s_both] eyebrow-hairline">
              AI voice simulation for enterprise teams
            </p>
            <h1 className="font-heading text-display leading-[0.95] tracking-tight mb-12 animate-[fadeIn_0.8s_var(--ease-reveal)_0.45s_both]">
              Conversations<br />
              <em className="text-accent">perfected.</em>
            </h1>
            <p className="text-lg text-copy-mid max-w-[520px] leading-[1.7] mb-10 animate-[fadeIn_0.7s_var(--ease-reveal)_0.6s_both]">
            ...
            <div className="animate-[fadeIn_0.7s_var(--ease-reveal)_0.75s_both]">
              <Link
                href="/contact"
          ...
          <div className="hidden lg:block animate-[fadeIn_1s_var(--ease-reveal)_0.5s_both]">
            <Image
