export const tags = {
  ...
  'ld-strategy': { label: 'L&D Strategy', description: 'Strategic approaches to learning and development in enterprise organizations.' },
  ...
  'enterprise-training': { label: 'Enterprise Training', description: 'Scaling training programs across large organizations with consistency and quality.' },
} as const
