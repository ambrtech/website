...
Conversation avoidance is the norm, not the exception. Research originally conducted by the authors of *Crucial Conversations* found that 70% of employees avoid difficult discussions with their boss, colleagues, or direct reports — a figure later revalidated by Bravely's survey of 500+ full-time employees. Only 24% report directly confronting a challenging situation. A further 53% deal with problems by simply ignoring them.
...
## The Case for Simulation: Practicing the Specific Conversation
...
Research from the authors of *Crucial Conversations*, later revalidated by Bravely's survey of 500+ employees, found that 70% of employees avoid difficult conversations with their boss, colleagues, or direct reports. Only 24% report directly confronting challenging situations. A further 53% cope by ignoring problems entirely, which tends to escalate rather than resolve them over time.
</FAQ>
